let handler = async (m, { conn }) => {
  ...
  if (m.sender.startsWith('62') || m.sender.startsWith('+62')) {
    var txt = `
(Indonesian)
**Ketentuan Layanan (TOS) - MIKU-CHAN ESM**
Dengan menggunakan MIKU-CHAN ESM, Anda setuju dengan ketentuan berikut:
...
Dengan menggunakan MIKU-CHAN ESM, Anda setuju dengan semua ketentuan yang berlaku.

*Ketentuan ini terakhir diperbarui pada 27 Agustus 2025.*
`
  } else {

    txt = `
(English)
**Term of Service (TOS) - MIKU-CHAN ESM**
By using MIKU-CHAN ESM, you agree to the following terms:
...
By using MIKU-CHAN ESM, you agree to abide by all applicable terms.
    ...
    extendedTextMessage: {
      ...
      contextInfo: {
        ...
        externalAdReply: {
          ...
          thumbnailUrl: 'https://drive.google.com/uc?export=view&id=1qh3Y7Sefph4VEDJQ2ij9tohkilXvrx51',
          sourceUrl: 'https://www.instagram.com/darr.eel_',
        }
      }, mentions: [m.sender]
    }
  }, { quoted: fkon });
